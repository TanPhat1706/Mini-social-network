...
export default function PreviewCombos({ phase, userAvatarUrl, userName, theme }: PreviewCombosProps) {
  ...
  const config = {
    ...
    WORLDCUP: [
      ...
      { frame: 'css-frame-wc-confetti', color: 'css-color-wc-argentina', label: 'Combo Argentina', labelColor: '#cbd5e1', glow: '#94a3b8', border: 'rgba(203, 213, 225, 0.5)' },
      ...
      // Thay viền lửa chung chung bằng viền Vietnam Special cực xịn
      { frame: 'css-frame-wc-vietnam-special', color: 'css-color-wc-vietnam', label: 'Combo Việt Nam', labelColor: '#fca5a5', glow: '#ef4444', border: 'rgba(239, 68, 68, 0.5)' }
    ]
  }[theme];
  return (
