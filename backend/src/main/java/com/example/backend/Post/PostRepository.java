...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    // PROFILE POSTS
    // =========================
    @Query(value = "SELECT p FROM Post p LEFT JOIN FETCH p.media WHERE p.author.id = :authorId",
    ...
    @Query(value = "SELECT p FROM Post p LEFT JOIN FETCH p.media WHERE p.author.studentCode = :studentCode",
           countQuery = "SELECT COUNT(DISTINCT p) FROM Post p WHERE p.author.studentCode = :studentCode")
